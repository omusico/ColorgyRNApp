...
public class ReactNestedScrollView extends NestedScrollView  {
  // private final OnScrollDispatchHelper mOnScrollDispatchHelper = new OnScrollDispatchHelper();
  // private boolean mRemoveClippedSubviews;
  // private @Nullable Rect mClippingRect;

  // EDITED: 2.
  public ReactNestedScrollView(Context context, AttributeSet attrs) {
    super(context, attrs);
  }
  ...
  //       updateClippingRect();
  //     }
  //     // EDITED: 3. Disable this non-public method
